...
export { CharacterEquipamentPanel } from './character-equipament-panel/character-equipament-panel.component';
export { CharacterInventoryPanel } from './character-inventory-panel/character-inventory-panel.component';
